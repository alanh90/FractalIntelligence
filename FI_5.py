...
================================================================================
      Dataset  FI Balanced Accuracy  FI Training Time (s)  FI Prediction Time (s)
        Moons              0.570000                1.7814                  0.0284
      Circles              0.700000                0.0714                  0.0204
       Digits              0.161913                0.0763                  0.0636
         Iris              0.666667                0.0783                  0.0105
Breast Cancer              0.792659                0.0741                  0.0333
         Wine              0.463492                0.0705                  0.0095
'''
...
# Parameters
NUM_POINTS = 200
# Convert SCALES to a NumPy array with a fixed dtype to avoid "reflected list" errors in Numba:
SCALES = np.array([50, 100, 200], dtype=np.int64)  # partial patterns
PARAM_LIMIT = 10.0
POP_SIZE = 5
GENERATIONS = 3
